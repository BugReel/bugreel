...
(function () {
  ...
  const translations = {
    ...
    ru: {
      ...
      guide_link_intro: 'Сразу после загрузки, <strong>не дожидаясь обработки</strong>:',
      guide_link_steps: '<li>Нажмите кнопку <strong>Трекер задач</strong> (синяя, справа вверху)</li><li>Найдите задачу \u2014 фильтр по пользователю, проекту, статусу</li><li>Или введите ID (напр. <code>BUG-42</code>) в поиске</li><li>Нажмите на задачу \u2192 подтвердите</li>',
      guide_link_draft: 'Привязка сохраняется как <strong>черновик</strong>. Ничего не отправляется в трекер, пока вы не нажмёте \u00abОтправить\u00bb на шаге 4.',
      guide_link_nowait_note: '<strong>Не нужно ждать</strong>Привязали \u2192 перешли к следующей задаче \u2192 записали \u2192 привязали. Вернётесь позже и отправите всё разом.',
      guide_review_intro: 'Когда обработка завершена (30\u201360 сек), на странице появится AI-карточка.',
      guide_review_checklist_title: 'Чек-лист перед отправкой',
      guide_review_checklist: '<li>Заголовок понятный? \u2192 нажмите <strong>Редактировать</strong></li><li>Скриншоты показывают проблему? \u2192 добавьте кликом по таймлайну</li><li>AI правильно описал баг?</li>',
      guide_review_sending_title: 'Отправка',
      guide_review_sending_linked: '<strong>Привязана к задаче</strong> (жёлтый бейдж): нажмите <strong>Отправить</strong>',
      guide_review_sending_new: '<strong>Новый баг</strong>: Трекер задач \u2192 Создать новую задачу (внизу списка)',
      guide_batch_steps: '<li>Запись #1 \u2192 привязка \u2192 следующая</li><li>Запись #2 \u2192 привязка \u2192 следующая</li><li>Откройте дашборд \u2192 фильтр <strong>\u00abНе отправлено в трекер\u00bb</strong></li><li>Проверьте и отправьте по очереди</li>',
      guide_batch_status: 'В расширении (RECENT): <code>...</code> обработка \u2022 <code>review</code> ожидает проверки \u2022 <code>BUG-14</code> отправлено',
