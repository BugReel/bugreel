...
(function () {
  ...
  const translations = {
    en: {
      ...
      rec_opt_mic: 'Record microphone',
      rec_mic_test: 'Test mic',
      rec_mic_test_stop: 'Stop test',
      rec_mic_denied: 'Microphone unavailable — the recording will have no voice-over.',
      rec_chip_screen: 'Screen',
      rec_chip_mic: 'Microphone',
      rec_chip_mic_off: 'Mic off',
      rec_chip_sysaudio: 'System audio',
      rec_chip_no_sysaudio: 'No system audio',
    ...
    ru: {
      ...
      rec_opt_mic: 'Записывать микрофон',
      rec_mic_test: 'Проверить микрофон',
      rec_mic_test_stop: 'Остановить проверку',
      rec_mic_denied: 'Микрофон недоступен — запись будет без голоса.',
      rec_chip_screen: 'Экран',
      rec_chip_mic: 'Микрофон',
      rec_chip_mic_off: 'Микрофон выкл.',
      rec_chip_sysaudio: 'Звук системы',
      rec_chip_no_sysaudio: 'Без звука системы',
