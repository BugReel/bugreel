...
(function () {
  ...
  const translations = {
    en: {
      ...
      index_desc: 'Your screen recordings',
      onboarding_title: 'Make your first recording in 3 steps',
      onboarding_step1_title: 'Install the extension',
      onboarding_step1_desc: 'Add the browser extension — it captures your screen and uploads here automatically.',
      onboarding_step1_cta: 'Install extension',
      onboarding_step2_title: 'Pin the icon',
      onboarding_step2_desc: 'Open the puzzle icon next to the address bar and pin the extension so it stays one click away.',
      onboarding_step3_title: 'Click record',
      onboarding_step3_desc: 'Click the extension icon → Record. When you stop, the video lands here with a shareable link.',
      onboarding_token_hint: 'Need a token? Generate one in <a href="/settings">Settings → Extension token</a>.',
      onboarding_connect_text: 'Already installed the extension? Connect it to your account so your recordings are saved here and open on any device.',
      onboarding_connect_cta: 'Connect to your account',
      ...
      lesson_pack: 'Learning',
      learning_goals: 'You will learn',
      key_concepts: 'Key concepts',
      practical_steps: 'Steps',
      prerequisites: 'Prerequisites',
      copy: 'Copy',
      ask_ai: 'Ask AI',
      ask_ai_hint: 'Cited timestamps are clickable',
      ask_ai_placeholder: 'Ask anything about this recording...',
      ai_chat_empty: 'Ask anything about this recording — the AI grounds answers in the transcript.',
      ai_chat_suggest_summary: 'Summarize the key points',
      ai_chat_suggest_actions: 'What was decided or needs to be done?',
      ai_chat_suggest_problems: 'What problems or questions came up?',
      ai_chat_thinking: 'Thinking…',
      ai_chat_error: 'Could not get an answer',
      send: 'Send',
      copy_link: 'Copy link',
      copy_share_text: 'Copy share text with AI summary',
      ...
      quota_manage: 'Manage subscription',
      quota_expired: 'Expired',
      quota_expires_soon: 'Expires in {n} days',
      quota_active_until: 'Active until {date}',
      quota_period_monthly: 'Monthly',
      quota_period_yearly: 'Yearly',
      ...
      quota_cancelled: 'Subscription cancelled',
      quota_paused: 'Subscription paused',
      quota_resume: 'Resume subscription',
      quota_resume_confirm: 'Resume your subscription now?',
      quota_paused_until: 'Paused — resumes {date}',
      quota_cancelled_until: 'Cancelled — access until {date}',

      // Retention / cancel flow
      cancel_why: 'Why do you want to cancel?',
      cancel_reason_expensive: 'Too expensive',
      cancel_reason_not_using: 'Not using the service',
      cancel_reason_features: 'Missing features I need',
      cancel_reason_switching: 'Switching to another service',
      cancel_reason_temporary: 'Temporarily don\'t need it',
      cancel_offer: 'We have an offer',
      cancel_accept: 'Accept',
      cancel_decline: 'No, cancel subscription',
      cancel_losing: 'Here\'s what you\'ll lose',
      cancel_feedback_placeholder: 'Tell us what we can improve (optional)',
      cancel_back: 'Back',
      cancel_confirm: 'Cancel subscription',
      cancel_done: 'Subscription cancelled',
      cancel_paused: 'Subscription paused',
      cancel_active_until: 'Access continues until',
      cancel_resumes: 'Resumes',
      cancel_special_offer: 'A special offer for you',
      cancel_discount_desc: 'on your next month',
      cancel_one_time: 'One-time offer',
      cancel_get_discount: 'Get 30% off',
      cancel_pause_title: 'Pause your subscription',
      cancel_pause_desc: 'Take a break — your recordings are preserved, billing paused. You can resume anytime.',
      cancel_pause_confirm: 'Pause for',
      cancel_downgrade_title: 'Try a more affordable plan',
      cancel_downgrade_desc: 'Instead of cancelling, switch to a cheaper plan and keep access to your recordings.',
      cancel_view_plans: 'View plans',
      cancel_feedback_title: 'Tell us more',
      cancel_feedback_desc: 'We\'re actively improving. Your feedback helps make the product better.',
      cancel_stay: 'Stay',
      cancel_access_info: 'Your current plan stays active until',
      cancel_access_info2: 'After that, your account switches to Free.',
      cancel_data_warning: 'You have',
      cancel_data_warning2: 'Old recordings will be deleted after downgrade.',
      close: 'Close',
      great: 'Great!',
      days: 'days',
      month: 'month',
    ...
    ru: {
      ...
      // Index page
      index_title: 'Записи',
      index_desc: 'Ваши записи экрана',
      onboarding_title: 'Сделайте первую запись за 3 шага',
      onboarding_step1_title: 'Установите расширение',
      onboarding_step1_desc: 'Поставьте расширение в браузер — оно записывает экран и автоматически загружает видео сюда.',
      onboarding_step1_cta: 'Установить расширение',
      onboarding_step2_title: 'Закрепите иконку',
      onboarding_step2_desc: 'Нажмите на пазл справа от адресной строки и закрепите расширение — иконка останется на панели для быстрого доступа.',
      onboarding_step3_title: 'Нажмите «Записать»',
      onboarding_step3_desc: 'Кликните по иконке расширения → «Записать». Когда остановите — видео появится здесь со ссылкой для отправки.',
      onboarding_token_hint: 'Нужен токен? Сгенерируйте его в <a href="/settings">Настройках → Токен расширения</a>.',
      onboarding_connect_text: 'Уже установили расширение? Подключите его к аккаунту — тогда записи будут сохраняться здесь и открываться с любого устройства.',
      onboarding_connect_cta: 'Подключить к аккаунту',
      ...
      chapters: 'Главы',
      ai_selected: 'Выбрано AI',
      added_manually: 'Добавлено вручную',
      action_items: 'Что нужно сделать',
      to_do: 'Сделать',
      decisions: 'Решения',
      open_questions: 'Открытые вопросы',
      lesson_pack: 'Обучение',
      learning_goals: 'Вы узнаете',
      key_concepts: 'Ключевые понятия',
      practical_steps: 'Шаги',
      prerequisites: 'Что нужно знать',
      copy: 'Скопировать',
      ask_ai: 'Спросить ИИ',
      ask_ai_hint: 'Таймкоды в ответе — кликабельны',
      ask_ai_placeholder: 'Спросите что угодно про эту запись...',
      ai_chat_empty: 'Спросите что угодно про эту запись — ИИ отвечает строго на основе расшифровки.',
      ai_chat_suggest_summary: 'Кратко суммируй ключевые моменты',
      ai_chat_suggest_actions: 'Что решили и что нужно сделать?',
      ai_chat_suggest_problems: 'Какие проблемы и вопросы обсуждали?',
      ai_chat_thinking: 'Думаю…',
      ai_chat_error: 'Не удалось получить ответ',
      send: 'Отправить',
      copy_link: 'Скопировать ссылку',
      copy_share_text: 'Скопировать текст с AI-резюме',
      ...
      quota_manage: 'Управление подпиской',
      quota_expired: 'Истекла',
      quota_expires_soon: 'Истекает через {n} дн.',
      quota_active_until: 'Активна до {date}',
      quota_period_monthly: 'Ежемесячная',
      quota_period_yearly: 'Годовая',
      ...
      quota_cancelled: 'Подписка отменена',
      quota_paused: 'Подписка на паузе',
      quota_resume: 'Возобновить подписку',
      quota_resume_confirm: 'Возобновить подписку сейчас?',
      quota_paused_until: 'На паузе — возобновится {date}',
      quota_cancelled_until: 'Отменена — доступ до {date}',

      // Retention / cancel flow
      cancel_why: 'Почему вы хотите отменить?',
      cancel_reason_expensive: 'Слишком дорого',
      cancel_reason_not_using: 'Не использую сервис',
      cancel_reason_features: 'Не хватает нужных функций',
      cancel_reason_switching: 'Перехожу на другой сервис',
      cancel_reason_temporary: 'Временно не нужно',
      cancel_offer: 'У нас есть предложение',
      cancel_accept: 'Принять',
      cancel_decline: 'Нет, отменить подписку',
      cancel_losing: 'Вот что вы потеряете',
      cancel_feedback_placeholder: 'Расскажите, что мы можем улучшить (необязательно)',
      cancel_back: 'Назад',
      cancel_confirm: 'Отменить подписку',
      cancel_done: 'Подписка отменена',
      cancel_paused: 'Подписка приостановлена',
      cancel_active_until: 'Доступ сохранится до',
      cancel_resumes: 'Возобновится',
      cancel_special_offer: 'Специальное предложение для вас',
      cancel_discount_desc: 'на следующий месяц подписки',
      cancel_one_time: 'Предложение действует один раз',
      cancel_get_discount: 'Получить скидку 30%',
      cancel_pause_title: 'Заморозьте подписку',
      cancel_pause_desc: 'Поставьте подписку на паузу — ваши записи сохранятся, оплата приостановится. Возобновить можно в любой момент.',
      cancel_pause_confirm: 'Заморозить на',
      cancel_downgrade_title: 'Попробуйте тариф подешевле',
      cancel_downgrade_desc: 'Вместо отмены можно перейти на более доступный тариф и сохранить доступ к записям.',
      cancel_view_plans: 'Посмотреть тарифы',
      cancel_feedback_title: 'Расскажите нам больше',
      cancel_feedback_desc: 'Мы активно развиваем продукт. Ваш отзыв поможет сделать сервис лучше.',
      cancel_stay: 'Остаться',
      cancel_access_info: 'Текущий тариф будет работать до',
      cancel_access_info2: 'После этого аккаунт переключится на Free.',
      cancel_data_warning: 'У вас',
      cancel_data_warning2: 'Старые записи будут удалены после перехода на Free.',
      close: 'Закрыть',
      great: 'Отлично!',
      days: 'дней',
      month: 'месяц',
